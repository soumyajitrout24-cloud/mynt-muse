    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-6 max-w-3xl mx-auto">
        ...
        <motion.p
          ...
          className="font-elegant text-base md:text-lg text-primary/55 leading-relaxed max-w-2xl mx-auto mb-10"
        >
        ...
        >
          <Link
            to="/contact"
            className="bg-primary text-primary-foreground font-body text-xs tracking-[0.2em] uppercase px-8 py-3.5 rounded-full hover:opacity-90 transition-opacity duration-300"
          >
            Book Consultation
          </Link>
          <Link
