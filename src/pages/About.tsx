      ...
      <div className="container mx-auto max-w-3xl">
        <FadeInSection>
          <div className="text-center mb-12 md:mb-14">
            <p className="font-elegant text-xs md:text-sm tracking-[0.3em] uppercase text-primary/50 mb-3">Our Story</p>
            <h1 className="font-display text-3xl md:text-5xl tracking-wider text-primary">About Us</h1>
        ...
        <FadeInSection delay={0.2}>
          <div className="space-y-6 md:space-y-8">
            <p className="font-elegant text-base md:text-xl text-primary/60 leading-relaxed text-center">
              At Mynt Girlfriend, we believe in true professionalism over transactions.
            </p>

            <p className="font-elegant text-sm md:text-base text-primary/50 leading-relaxed text-center">
            ...
            <div className="gold-border-card rounded-xl p-6 md:p-8 bg-card">
              <h2 className="font-display text-xl md:text-2xl text-primary mb-4 md:mb-5 tracking-wide">Our Standards</h2>
              <ul className="space-y-3">
                {[
                  ...
                  <li key={item} className="flex items-start gap-3">
                    ...
                    <span className="font-elegant text-sm md:text-base text-primary/50 leading-relaxed">{item}</span>
                  </li>
                ))}
              </ul>
            </div>
            ...
            <div className="gold-border-card rounded-xl p-6 md:p-8 bg-card">
              <h2 className="font-display text-xl md:text-2xl text-primary mb-3 md:mb-4 tracking-wide">Advance Booking</h2>
